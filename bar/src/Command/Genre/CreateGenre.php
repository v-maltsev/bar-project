...
use App\Model\Bar\UseCase\Genre\Create;
use App\Model\Bar\UseCase\Genre\Create\Handler;
...
class CreateGenre extends Command
{
    ...
    {
        $this
            ->setName('bar:genre:create')
            ->setDescription('Create new genre');
    }
